...
db.serialize(() => {
  ...
  // Insert sample books
  const sampleBooks = [
    { id: uuidv4(), title: 'The Great Gatsby', author: 'F. Scott Fitzgerald', description: 'A classic American novel set in the Jazz Age.', price: 12.99, category: 'Fiction', isbn: '9780743273565', stock_quantity: 50, image_url: 'https://images.pexels.com/photos/1130980/pexels-photo-1130980.jpeg', rating: 4.5 },
    { id: uuidv4(), title: 'To Kill a Mockingbird', author: 'Harper Lee', description: 'A timeless story of racial injustice and childhood innocence.', price: 14.99, category: 'Fiction', isbn: '9780061120084', stock_quantity: 30, image_url: 'https://images.pexels.com/photos/1130623/pexels-photo-1130623.jpeg', rating: 4.8 },
    { id: uuidv4(), title: 'The Catcher in the Rye', author: 'J.D. Salinger', description: 'A controversial and influential coming-of-age story.', price: 13.99, category: 'Fiction', isbn: '9780316769488', stock_quantity: 25, image_url: 'https://images.pexels.com/photos/1130641/pexels-photo-1130641.jpeg', rating: 4.2 },
    { id: uuidv4(), title: 'Pride and Prejudice', author: 'Jane Austen', description: 'A romantic novel exploring themes of love and social class.', price: 11.99, category: 'Romance', isbn: '9780141439518', stock_quantity: 40, image_url: 'https://images.pexels.com/photos/1130626/pexels-photo-1130626.jpeg', rating: 4.6 },
    { id: uuidv4(), title: 'The Hobbit', author: 'J.R.R. Tolkien', description: 'A fantasy adventure that precedes The Lord of the Rings.', price: 15.99, category: 'Fantasy', isbn: '9780547928227', stock_quantity: 35, image_url: 'https://images.pexels.com/photos/1130980/pexels-photo-1130980.jpeg', rating: 4.7 },
    { id: uuidv4(), title: '1984', author: 'George Orwell', description: 'A dystopian novel about totalitarianism and surveillance.', price: 13.99, category: 'Science Fiction', isbn: '9780451524935', stock_quantity: 45, image_url: 'https://images.pexels.com/photos/1130623/pexels-photo-1130623.jpeg', rating: 4.4 }
  ];
